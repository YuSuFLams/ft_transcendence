    ...
    return (
        <div className="absolute inset-0 mt-8 space-y-12 flex flex-col items-center justify-center">
            <div className="relative w-24 h-24 flex items-center justify-center">
                <motion.div
                    className="absolute inset-0 w-full h-full bg-blue-500 opacity-30 blur-xl rounded-full"
                    animate={{ scale: [1, 1.2, 1] }}
                    transition={{ repeat: Infinity, duration: 1.5, ease: "easeInOut" }}
                ></motion.div>

                <motion.div
                    className="w-20 h-20 border-[6px] border-gray-700 border-t-blue-500 rounded-full shadow-lg"
            ...
            <motion.h1
                className="text-2xl sm:text-3xl md:text-4xl font-[TORAJA] font-extrabold text-center text-white tracking-wide"
