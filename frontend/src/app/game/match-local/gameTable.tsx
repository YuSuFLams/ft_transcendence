...
const TableLocal: React.FC<TableLocalProps> = ({
  ...
  return (
    <div className="w-full h-full bg-neutral-900 absolute flex flex-col justify-center items-center overflow-hidden">
      ...
      <DrawTable 
        ballRef={ballRef}
        ballPosition={ballPosition} // Fixed
        positionPlayerPaddleLeft={positionPlayerPaddleLeft} // Fixed
        positionPlayerPaddleRight={positionPlayerPaddleRight} // Fixed
        paddlePlayerRightRef={paddlePlayerRightRef} // Fixed
        paddlePlayerLeftRef={paddlePlayerLeftRef} // Fixed
		/>
		</div>
